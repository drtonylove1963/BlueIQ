...
[assembly: InternalsVisibleTo("BlueIQ.Sdk.Client.Test")]
...
namespace BlueIQ.Sdk.Client.Client
{
    ...
    public static partial class ClientUtils
    {
        ...
        public static string? ParameterToString(object? obj, string? format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is bool boolean)
                return boolean
                    ? "true"
                    : "false";
            if (obj is WorkflowInstance.StatusEnum workflowInstanceStatusEnum)
                return WorkflowInstance.StatusEnumToJsonValue(workflowInstanceStatusEnum);
        ...
        /// </summary>
        public const string BASE_ADDRESS = "http://localhost:5000/api/v1";
